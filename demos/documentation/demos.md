...
This is a [dotnet tool](https://learn.microsoft.com/en-us/dotnet/core/tools/global-tools) showcasing a variety of dapr demos.
...
1. Navigate to the `demos` folder and run the following commands:
...
1. `--list-tenant` which will show you the tenants available for you
1. `--list-sub` which will show you subscriptions available for the tenant you're on
1. `--tenant` This option allows you to switch to a different tenant IE. `demos user --tenant <tenantid>`
...
1. __binding__ which is a dapr [binding](https://docs.dapr.io/developing-applications/building-blocks/bindings/) demo
1. __pubsub__ which is a dapr [Pub/sub](https://docs.dapr.io/reference/components-reference/supported-pubsub/) demo
1. __secrets__ which is a dapr [secrets](https://docs.dapr.io/developing-applications/building-blocks/secrets/) demo
1. __obs__ which is a dapr [observability](https://docs.dapr.io/developing-applications/building-blocks/observability/) demo
...
The pubsub 1 consist of the component and the [subscription](https://docs.dapr.io/developing-applications/building-blocks/pubsub/subscription-methods/) files.
